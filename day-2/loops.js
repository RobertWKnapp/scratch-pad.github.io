...
function getObjectLength(object) {
  // YOUR CODE BELOW HERE //
   var pairNumbers = [];
   for(var key in object){ 
    pairNumbers.push(object[key]);
// pairNumbers.key.length;
//let pairNumbers = Object.keys(object).length;

  }
  return pairNumbers.length;
